...
st.set_page_config(page_title="Stock Price Predictor by Obaid Sayyed", layout="wide")
...
# Stock Symbol input
stock_symbol = st.sidebar.text_input("Enter Stock Symbol Only (e.g., GOOG, TATAMOTORS.NS, AAPL), Google to find for your Stock","GOOGL")
...
if time_option == "Last 6 Months":
    ...
    start_date = date(2015, 1, 1)  # All Data
...
st.write(f"💰 Next Day Price Prediction: {next_day_pred:.2f}")

# ---------------- Display Model Metrics ----------------
st.subheader("Model Evaluation Metrics")
st.write(f"Average Deviation by Model: {mae:.3f}")
